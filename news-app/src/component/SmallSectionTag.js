...
import './SmallSectionTag.css'

class SmallSectionTag extends Component {
    render() {
        ...
        return (
            <span id='small_section_tag' style={{backgroundColor: backgroundColor, color: fontColor}}>
                {section}
            </span>
        );
    }
...
export default SmallSectionTag;